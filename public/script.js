            ...
            if (!value) {
                ...
                switch (fieldName) {
                    case 'name':
                        ...
                        break;
                    case 'email':
                        if (!rtlPatterns.email.test(value)) {
                            isValid = false;
            ...
            if (isFormValid) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #27ae60; padding: 1rem; background: #d5f5e3; border-radius: 4px; margin-top: 1rem;';
                        contactForm.insertAdjacentElement('beforebegin', successMessage);
                        contactForm.reset();
                        
                        const validFields = contactForm.querySelectorAll('.input-valid');
                        validFields.forEach(field => field.classList.remove('input-valid'));
                ...
                .catch(error => {
                    ...
                    errorMessage.style.cssText = 'color: #e74c3c; padding: 1rem; background: #fadbd8; border-radius: 4px; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '31af400e-9008-47f7-9ae1-f9d5d82d44a1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '31af400e-9008-47f7-9ae1-f9d5d82d44a1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '31af400e-9008-47f7-9ae1-f9d5d82d44a1';
